...
savefolder = strcat('data/fix_alpha_Coverage',num2str(R),'m')
if ~exist(savefolder, 'dir')
       mkdir(savefolder)
end

save(strcat('data/fix_alpha_Coverage',num2str(R),'m/output','_',num2str(aID),'.mat'),'finaldata','PARAMS')
save(strcat('data/fix_alpha_Coverage',num2str(R),'m/blockages','_',num2str(aID),'.mat'),'blockageDurations','PARAMS')
